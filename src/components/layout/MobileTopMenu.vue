<template>
  <b-dropdown class="d-xl-none" variant="link" no-caret right toggle-class="p-0" v-if="!user">
    ...
    <b-dropdown-item to="landingUrl">How It Works</b-dropdown-item>
    <b-dropdown-divider/>
...
export default {
  ...
  computed: {
    ...
    landingUrl() {
      return `${process.env.VUE_APP_LANDING_URL}how-cryptotask-works`;
    },
  },
};
</script>
